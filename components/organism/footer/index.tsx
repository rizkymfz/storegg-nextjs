                        ...
                        <div className="row gap-sm-0">
                            <div className="col-md-4 col-6 mb-lg-0 mb-25">
                                ...
                                <ul className="list-unstyled">
                                    <MenuFooter href='/' title='About Us' />
                                    <MenuFooter href='/' title='Press Release' />
                                    <MenuFooter href='/' title='Terms of Use' />
                                    <MenuFooter href='/' title='Privacy & Policy' />
                                </ul>
                            </div>
                            <div className="col-md-4 col-6 mb-lg-0 mb-25">
                                <p className="text-lg fw-semibold color-palette-1 mb-12">Support</p>
                                <ul className="list-unstyled">
                                    <MenuFooter href='/' title='Refund Policy' />
                                    <MenuFooter href='/' title='Unlock Rewards' />
                                    <MenuFooter href='/' title='Live Chatting' />
                                </ul>
                            </div>
                            <div className="col-md-4 col-12 mt-lg-0 mt-md-0 mt-25">
                                <p className="text-lg fw-semibold color-palette-1 mb-12">Connect</p>
                                <ul className="list-unstyled">
                                    <MenuFooter href='mailto: hi@store.gg' title='hi@store.gg' />
                                    <MenuFooter href='mailto: team@store.gg' title='team@store.gg' />
                                    <MenuFooter href='http://maps.google.com/?q=Pasific 12,
                                        Jakarta Selatan' title='Pasific 12, Jakarta Selatan' 
                                    />
                                    <MenuFooter href='tel: 02111229090' title='021 - 1122 -
                                            9090' 
                                    />
                                </ul>
                            </div>
